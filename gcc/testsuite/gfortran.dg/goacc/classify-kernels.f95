...
! { dg-final { scan-tree-dump-times "(?n)__attribute__\\(\\(oacc function \\(1, 1, 1\\), oacc kernels, oacc kernels parallelized, oacc parallel_kernels_gang_single_, omp target entrypoint\\)\\)" 1 "oaccdevlow" } }
